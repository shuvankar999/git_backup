...
public class BrakeReadingRequest {
	...
	public String toString() {
		return "BrakeReadingRequest [workPackNr=" + workPackNr + ", workOrderNr=" + workOrderNr +", workOrderTaskNr=" +workOrderTaskNr+ ", languageId=" +languageId+ "]";
	}
