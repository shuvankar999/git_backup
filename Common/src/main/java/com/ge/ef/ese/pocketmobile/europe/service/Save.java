 ...
 *         &lt;element name="saveRequest" type="{http://service.europe.pocketmobile.ese.ef.ge.com}SaveInput"/>
 *       &lt;/sequence>
 *     &lt;/restriction>
 *   &lt;/complexContent>
 * &lt;/complexType>
...
public class Save {
    ...
    @XmlElement(required = true)
    protected SaveInput saveRequest;
     ...
     *     
     */
    public SaveInput getSaveRequest() {
        return saveRequest;
    }
     ...
     *     
     */
    public void setSaveRequest(SaveInput value) {
