...
@Service
@Transactional
public class SaveEquipStaticServiceImpl implements SaveEquipStaticSerivce {

	@Autowired
	SaveEquipStaticRepository saveEquipStaticRepository;
	...
	@Override
	public List<BaseResponse> saveEquipmentStatic(SaveEquipDetailsRequest saveEquipDetailsRequest, String appCd,
			String ssoId) {

		setSaveEquipStaticData(saveEquipDetailsRequest);
		Map<String, Object> resultMap =  saveEquipStaticRepository.saveEquipmentStatic(saveEquipStaticRequest, appCd, ssoId);
		Map<String, Object> resultMapOthers =  new HashMap();
