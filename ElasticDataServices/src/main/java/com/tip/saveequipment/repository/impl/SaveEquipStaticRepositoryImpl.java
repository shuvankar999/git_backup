...
import com.tip.saveequipment.repository.SaveEquipStaticRepository;
 ...
 */
@Repository
public class SaveEquipStaticRepositoryImpl implements SaveEquipStaticRepository, CallableStatementCreator{

static final Logger logger = LoggerFactory.getLogger(SaveEquipStaticRepositoryImpl.class);
	...
	@Override
	public Map<String, Object> saveEquipmentStatic(SaveEquipStaticRequest saveEquipStaticRequest, String appCd,
			String ssoId) {
		...
		try {
			...
			SaveEquipStaticRepositoryImpl saveEquipStaticRepositoryImpl = new SaveEquipStaticRepositoryImpl();
			...
			saveEquipStaticRepositoryImpl.procedureCall = "{call " + ElasticSearchConstant.PROC_SAVE_EQUIP_STATIC + " (?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?,?)}";
