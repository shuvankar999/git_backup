...
public class StyleUtil{
	...
	public PdfPCell createCell(String value, int align, String cellType, String labelType){
		Font font = new Font();
		if(cellType.equalsIgnoreCase("ColName")){
			if(EstimationReportConstants.LABLETYPE_VAT.equalsIgnoreCase(labelType))
				font = getFieldNameFont(8f);
			else if(EstimationReportConstants.LABLETYPE_TOTAL.equalsIgnoreCase(labelType))
				font = getFieldFont(10f, Font.BOLD);
			else
				font = getFieldFont(10f);
		}else if (cellType.equalsIgnoreCase("ColVal")) {
			if(EstimationReportConstants.LABLETYPE_VAT.equalsIgnoreCase(labelType))
				font = getFieldNameFont(8f);
			else if(EstimationReportConstants.LABLETYPE_TOTAL.equalsIgnoreCase(labelType))
				font = getFieldFont(12f, Font.BOLD);
			else
				font = getFieldFont(10f, Font.BOLD);
		}
